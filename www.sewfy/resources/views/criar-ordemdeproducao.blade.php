...
<html lang="pt-BR">
  <head>
    ...
    />
    <link rel="stylesheet" href="../../menu/menu.css?v=1.0.3" />
    <link
      rel="stylesheet"
      href="../../ordensdeproducao/requisicao/requisicao.css?v=1.0.3"
    />
  </head>
  ...
  <body>
        ...
        <div class="steps-bar">
          <div class="steps-wrapper">
            ...
            <div class="step-item">
              ...
              <span class="step-label" id="step-label-4"
                >Insumos e Serviços</span
              >
            </div>
          ...
          <div class="modalBoxInsumos">
            ...
            <form class="modal-form">
              <div class="form-selects">
                ...
                <div class="form-group">
                  <label class="form-label" id="label-quantidade"
                    >Quantidade *</label
                  >
              ...
              <div class="info-box">
                <div class="info-box-header">
                  ...
                  <span class="info-box-title"
                    >Informações de Insumos e Serviços</span
                  >
                </div>
                ...
                <div class="info-fields">
                  ...
                  <div class="info-field">
                    ...
                    <span class="info-field-value" id="previewFornecedor"
                      >—</span
                    >
                  </div>
                  <div class="info-field">
                    ...
                    <span class="info-field-value status-pendente"
                      >Pendente</span
                    >
                  </div>
                </div>
              ...
              <div class="added-box">
                <div class="added-box-header">
                  ...
                  <span class="added-box-title"
                    >Insumos e Serviços Adicionados</span
                  >
                </div>
    ...
    <script
      type="module"
      src="../../ordensdeproducao/requisicao/requisicao.js"
      defer
    ></script>
  </body>
</html>
