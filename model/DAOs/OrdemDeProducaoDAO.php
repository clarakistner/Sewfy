...
class OrdemDeProducaoDAO
{
    ...
    public function criarOP(OrdemDeProducao $op): int
    {
        try {
            ...
            error_log("Erro ao tentar criar OP: " . $e->getMessage());
            return 0;
        }
    }
    ...
    public function buscarOPs($idUsuario): array
    {
        try {
            ...
            error_log("Erro ao tentar buscar OPs: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function atualizaDataEntrega(OrdemDeProducao $op)
    {
        try {
            ...
            error_log("Erro ao tentar atualiza a data de entrega: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function contaOPs($idUsuario)
    {
        try {
            ...
            error_log("Erro ao tentar contar OPs: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function buscarOPPorID($idOP, $idUsuario)
    {
        try {
            ...
            error_log("Erro ao tentar buscar OP pelo ID: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function editarOP($custot, $custou, $quebra, $qtd, $idOP)
    {
        try {
            ...
            error_log("Erro ao tentar editar OP: " . $e->getMessage());
            return false;
        }
    }
}
